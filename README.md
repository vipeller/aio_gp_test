...
Configure a dataflow to route telemetry from AIO to the Eventstream using the Operations Experience UI. For detailed instructions see [Create a Dataflow in the Operations Experience](./doc/CREATE_DATAFLOW.md)
